...
#define CUSTOM_MACHINE_NAME "J.A.K.E."
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE   NEO_GRBW // NEO_GRBW / NEO_GRB - four/three channel driver type (defined imarlin n Adafruit_NeoPixel.h)
...
#define Z_SERVO_ANGLES {0,0, 0,0, 10,75}
